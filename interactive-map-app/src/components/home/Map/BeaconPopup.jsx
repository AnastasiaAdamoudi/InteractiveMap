...
import JoinBeaconButton from "./JoinBeaconButton";
import PropTypes from "prop-types";

const BeaconPopup = ({ beacons, beacon, index }) => {
  ...
  console.log("Beacon in BeaconPopup:", beacon)
  console.log("Index in BeaconPopup:", index)

  return (
    <div className="beacon-popup-container">
      <h2 className="beacon-popup-header">
        Beacon #{index + 1} created by {beacon.creatorName} (
        {beacon.creatorEmail})
      </h2>
      ...
      <JoinBeaconButton beacons={beacons} index={index} />
    </div>
  );
};
